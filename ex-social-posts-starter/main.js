...
// rendere dinamici il nome, la foto profilo, l'articolo, l'immagine.
// Per 5 volte mi appendo i post
// mi prendo il div che deve contenere i post
const containerDiv = document.querySelector('.posts-list');

posts.forEach((singlePost) => {

    // Scorro l'array sfogliando gli oggetti
    const content = singlePost.content;
    const media = singlePost.media;
    const likes = singlePost.likes;
    const name = singlePost.author.name;
    const image = singlePost.author.image;
    const created = singlePost.created;

    // prendo gli elementi dal DOM corrispondendi e ci appendo gli elementi del gruppo
    const postPrint = `
    <div class="post">
    ...
    `;
    containerDiv.innerHTML += postPrint;
});
